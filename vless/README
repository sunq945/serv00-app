...
一键下载并执行autocheck脚本 (目前不支持ARGO) __(可以添加到serv00的cron job上作为定时检查任务)__
```
curl -fsSL  https://raw.githubusercontent.com/sunq945/Sing-box/main/autocheck.sh -o autocheck.sh && chmod +x autocheck.sh && ./autocheck.sh
```
